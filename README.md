# Hướng dẫn cập nhật module videoclips lên phiên bản 4.6.00

Gói cập nhật này hỗ trợ các module videoclips sau: 4.0.29, 4.1.00, 4.1.01, 4.2.01, 4.2.02, 4.2.03, 4.3.00, 4.4.02, 4.5.00, 4.5.02
...
Tải gói cập nhật tại https://github.com/nukeviet/module-videoclips/releases/download/4.6.00/update-to-4.6.00.zip, sau đó giải nén và upload lên site đúng cấu trúc (thư mục install nhập vào thư mục install trên website).
