...
// ID goi cap nhat
$nv_update_config['packageID'] = 'NVUVIDEOCLIPS4502';
    ...
    try {
        ...
        if (!$num) {
            $db->query("INSERT INTO " . $db_config['prefix'] . "_setup_extensions (
                ...
                64, 'module', 'videoclips', 0, 1, 'videoclips', 'videoclips', '" . $nv_update_config['to_version'] . " " . $nv_update_config['release_date'] . "', " . NV_CURRENTTIME . ", 'VINADES.,JSC (contact@vinades.vn)',
                ''
            )");
        } else {
